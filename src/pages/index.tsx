...
const hints = [
  {
    ...
    link:
      "https://join.slack.com/t/vislycommunity/shared_invite/enQtOTMxODg4NzA4MDIwLWQ2OGUwOTczYmMyMWEwZjVhYjVmN2JjMzZmYzZmNzBjODI1NzVkZGMzNjIwMzM5MDA4YjEwNmQwNzRjNjM0ZDg",
    icon: moon,
  },
  {
  ...
  {
    text:
      "Need a blank canvas? Remove StarterApp from Visly to start from scratch.",
    ...
    >
      ...
      >
        <a href={hint.link} target="_blank" rel="noreferrer">
          <Welcome.Hint text={hint.text} icon={hint.icon} />
        </a>
      </Welcome>
    </div>
  )
